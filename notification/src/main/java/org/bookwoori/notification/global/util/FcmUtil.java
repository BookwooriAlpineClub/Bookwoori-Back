package org.bookwoori.notification.global.util;
...
import static org.bookwoori.notification.global.exception.CustomExceptionStatus.MESSAGE_TYPE_ERROR;
import static org.bookwoori.notification.global.util.MessageType.FILE;
import static org.bookwoori.notification.global.util.MessageType.TALK;
...
public class FcmUtil {
    ...
    // 단일 전송 메세지 만들기
    public Message makeMessage(String targetToken, String title, String body, String platform, Map<String, String> data) throws FirebaseMessagingException {
    ...
    // 일괄 전송 메세지 만들기
    public MulticastMessage makeMessage(List<String> targetTokens, String title, String body, String platform, Map<String, String> data) throws FirebaseMessagingException {
        Notification notification = Notification
                .builder()
                .setTitle(title)
                .setBody(body)
