...
public interface ClimbingRepository extends JpaRepository<Climbing, Long> {
    ...
    List<Climbing> findByServer_ServerIdAndStatus(Long serverId, ClimbingStatus climbingStatus);

    List<Climbing> findByServer_ServerIdAndStatusIn(Long serverId, List<ClimbingStatus> statuses);
}
